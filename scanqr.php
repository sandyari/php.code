...
require "koneksi.php";
// memanggil file cek belum login
require "cek.php";
?>
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapsemasuk" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="manual.php">Qr Code</a>
                        ...
                        <div class="collapse" id="collapsekeluar" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="codeqrcoba.php">Qr Code</a>
                                <a class="nav-link" href="index.php">Manual</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="login.html">Stock Barang</a>
                                <a class="nav-link" href="register.html">Barang Masuk</a>
                                <a class="nav-link" href="password.html">Barang Keluar</a>
                                <a class="nav-link" href="password.html">Karyawan</a>
                            </nav>
                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="text" id="text" readonyy="" placeholder="scan qrcode"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
